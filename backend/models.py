...
class Conversation(db.Model):
    ...
    messages = db.relationship('Message', backref='conversation', cascade="all, delete-orphan") # cascade="all, delete-orphan" to delete the messages when the conversation is deleted
