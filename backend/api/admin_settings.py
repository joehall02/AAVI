...
@admin_settings_ns.route('/admin_settings', methods=['GET', 'POST', 'DELETE']) 
...
@admin_settings_ns.route('/admin_settings/<string:username>', methods=['GET'])
...
@admin_settings_ns.route('/admin_settings/<int:account_id>', methods=['DELETE'])
class AdminSettingResource(Resource):
    #@jwt_required() # Protect this endpoint with JWT
